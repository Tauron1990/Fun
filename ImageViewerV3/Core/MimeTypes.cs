...
namespace ImageViewerV3.Core
{
    ...
    public static class MimeTypes
    {
        ...
        /// </summary>
        private static string FallbackMimeType { get; set; }
        ...
        public static string GetMimeType(string fileName)
        {
            ...
            if (dotIndex == -1 || fileName.Length <= dotIndex + 1) return FallbackMimeType;
            return TypeMap.TryGetValue(fileName.Substring(dotIndex + 1), out var result) ? result : FallbackMimeType;
        }
    }
}
